                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        <li class="nav-item active">
                            <a class="nav-link" href="#">Edit courses <span
                                    class="sr-only">(current)</span></a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/admin/create">Create Course</a>
                        </li>
                        <!-- <li class="nav-item">
                                    ...
                                    <div class="card mb-2 ">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-btns row flex-column   mx-1 ">
                                                <a class="btn btn-primary mt-auto p-2 align-self-end" href="${pageContext.request.contextPath}/admin/edit?id=${cu.id}">Edit course</a>
